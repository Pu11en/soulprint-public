...
export interface MoltbotEnv {
  ...
  SOUL_DATA: R2Bucket; // R2 bucket for user workspace data (soul-home-data)
  ...
  // Fly.io provisioning
  FLY_API_TOKEN?: string; // Fly.io API token for per-user container provisioning
  // AWS Bedrock (for direct AI calls)
